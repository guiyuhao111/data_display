    ...
    layui.use(['table','laydate','form'],function () {
        ...
        table.render({
            ...
            cols: [[
                ...
                ,{field: 'title', title: '标题',width:"14%"}
                ,{field: 'link', title: '链接',width:"14%"}
                ,{field: 'author', title: '作者',width:"14%"}
                ,{field: 'type', title: '类型',width:"14%"}
                ,{field: 'pubTime', title: '发布时间',width:"14%"}
                ,{field: 'remark', title: '备注',width:"14%"}
                ,{fixed:"right",align:'center',toolbar:'#inlineTool',title:'操作',width:"14%"}
            ]],
